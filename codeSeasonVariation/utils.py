...
def build_config(args):
    ...
    elif config['dataset'] == 'lcz42CityVariation':
        config['encoder']['params']['class_num'] = 6
        config['data']['image_list_root'] = 'data/lcz42CityVariation/'
    elif config['dataset'] == 'sen12SeasonVariation':
        config['encoder']['params']['class_num'] = 7
        config['data']['image_list_root'] = 'data/sen12SeasonVariation/'
    else:
