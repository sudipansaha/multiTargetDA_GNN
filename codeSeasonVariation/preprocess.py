...
def image_train(resize_size=256, crop_size=224):
    normalize = transforms.Normalize(mean=[0.123, 0.114, 0.114], std=[0.075, 0.075, 0.096])
...
class ImageList(Dataset):
    ...
    def __getitem__(self, index):
        ...
        elif self.dataset_name in ['office-home', 'pacs','lcz42CityVariation','sen12SeasonVariation']:
